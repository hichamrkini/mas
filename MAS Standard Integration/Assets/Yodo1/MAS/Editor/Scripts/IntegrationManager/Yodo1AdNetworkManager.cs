...
public class Yodo1AdNetworkManager
{
    ...
    public void InitAdNetworkConfig()
    {
        ...
        //TextAsset targetFile = Resources.Load<TextAsset>("4.8.10");
        //try
        //{
        //    yodo1AdNetworkConfig = new Yodo1AdNetworkConfig();
        //    yodo1AdNetworkConfig = JsonUtility.FromJson<Yodo1AdNetworkConfig>(targetFile.text);
        //    Debug.Log(Yodo1U3dMas.TAG + ": GetAdNetworkConfigFromLocal yodo1AdNetworkConfig curSDKVersion: " + yodo1AdNetworkConfig.sdkVersion
        //        + " android network size: " + (yodo1AdNetworkConfig.android != null ? yodo1AdNetworkConfig.android.Length : 0)
        //        + " ios networks size : " + (yodo1AdNetworkConfig.ios != null ? yodo1AdNetworkConfig.ios.Length : 0)
        //        + " androidStandard size: " + yodo1AdNetworkConfig.androidStandard.Count
        //        + " androidFamily size: " + yodo1AdNetworkConfig.androidFamily.Count
        //        + " iosStandard size: " + yodo1AdNetworkConfig.iosStandard.Count);
        //}
        //catch (Exception e)
        //{
        //    Debug.LogError(Yodo1U3dMas.TAG + ": GetAdNetworkConfigFromLocal error : " + e.Message);
        //}
        //#endregion
    ...
    */
    ...
    private static Yodo1AdNetworkConfig GetAdNetworkConfigFromServer(String curSDKVersion)
    {
        ...
        string url = "https://sdk-mas.yodo1.com/v1/unity/version-mapping";
